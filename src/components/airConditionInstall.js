...
const Airconditioning = () => {
  return (
    <div className="Airconditioning">
      ...
      <div> <p>AIR CONDITIONING INSTALLATION & REPAIR</p>
        <p>RockRuth Heating & Air serving Atlanta</p>
        ...
        <p>HIGH-QUALITY WORK</p>
            <p><i>Because we value your comfort, we'll arrive at your location with the 
                ...
                that may extend the life of your system.</i></p>
        <p>HVAC SERVICES FOR RESIDENTIAL & COMMERCIAL</p>
            <p>RESIDENTIAL SERVICES</p>
                <p><i>· AC Installation
                    ...
                    · Water Heaters
                    · Indoor Air Quality Service</i></p>
            <p>COMMERCIAL SERVICES:</p>
                <p><i>· Commercial Heating & Air Conditioning
                    · Rooftop HVAC Service
                    · Commercial Electric Repair & Maintenance</i></p>
        <p>Current Specials & Discounts</p>
            <p><i>-FREE ESTIMATES!!!
                Residential & Commercial
                -Free Duct Cleaning with All Full System Replacements (Value $1000) 
                -$69 Service Call/Free With Repair 
                -$79 Heat Tune Up
                -2 Ton Gas Furnace Special Starting @ $1398 (40,000 BTU)
                - 2 Ton Full Heat & A/C System Starting @ $3750</i></p>
        ...
        <p>Air Duct Cleaning</p>
            <p><i>The ductwork in your home or business is one of the most often ignored 
                  ...
                  done right! We make a point to provide only the very best to our consumers.</i></p>
        <p>At your service</p>
            <p><i>Our workmanship is 100% guaranteed. We're a locally owned and operated 
                  ...
                  you currently have. </i></p>
        <p>FAQ's</p>
            <p><i>You have questions, we have answers...</i></p>
      </div>
    </div>
  )
}
